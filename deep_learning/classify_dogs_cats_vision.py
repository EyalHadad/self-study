...
def create_model():
    ...
    model.compile(loss='binary_crossentropy', optimaizer=optimizers.RMSprop(lr=1e-4), metrics=['acc'])  # crossentropy
...
def data_preprocessing(train_dir, validation_dir):
    ...
    trin_generator = train_datagen.flow_from_directory(train_dir, target_size=(150, 150), batch_size=20,
...
if __name__ == '__main__':
    ...
    data_preprocessing(train_dir, valid_dir)
    i = 5
