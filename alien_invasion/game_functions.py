...
def check_play_button(stats, play_button, mouse_x, mouse_y, aliens, bullets, ai_settings, ship, screen):
...
def check_events(ai_settings, screen, ship, bullets,stats,play_button, aliens):
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(stats,play_button, mouse_x, mouse_y, aliens, bullets,ai_settings, ship, screen)
