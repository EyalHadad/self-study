...
def show_results(past_conf, past_fatal, pred_conf, pred_fatal, country_n, date_e):
    ...
    future_fatal = true_data['Fatalities'].apply(lambda x: np.log(x))
    ...
    axarr[0].set_ylabel("Log(#Confirmed Cases)")
    ...
    axarr[1].set_ylabel("Log(#Fatalities Cases)")
...
if __name__ == "__main__":
    confirmed_d, fatalities_d = get_data('Spain', '2020-02-26', '2020-03-19')
